...
public class ExportSql {
    ...
    private static String getExportCommand() {
        ...
        String exportDatabaseName = "20200320_emm";// 导入的目标数据库的名称
        String exportPath = "D:\\www\\emm.sql";// 导入的目标文件所在的位置
        String MysqlPath = "D:\\softwaresinstall\\mysql-5.7.24-winx64\\bin\\"; //路径是mysql中
        // 注意哪些地方要空格，哪些不要空格
    ...
    public static void function2() {
        try {
            ...
            // 调用 调用mysql的安装目录的命令
            Process child =  rt.exec("D:\\softwaresinstall\\mysql-5.7.24-winx64\\bin\\mysqldump -uroot  -proot -hlocalhost 20200320_emm");
            ...
            fout = new FileOutputStream("D:\\www\\emm.sql");
